...
Route::group(['prefix' => 'laravel-filemanager', 'middleware' => ['web', 'isAdmin']], function () {
...
Route::get('/solutions','UserController@solutions');
Route::get('/services/{id}','UserController@service');


Route::middleware(['isAdmin'])->prefix('admin')->group(function(){
    Route::get('/','AdminController@index');

    Route::get('/contact/0','AdminController@contact0');
    Route::get('/contact/1','AdminController@contact1');
    Route::get('/contact/toggle/{id}','AdminController@togglecontact');

    Route::get('/testimonials/add','AdminController@addtestimonial');
    Route::get('/testimonials/view','AdminController@viewtestimonial');
    Route::get('/testimonials/edit/{id}','AdminController@edittestimonial');
    Route::post('/testimonials/store','AdminController@storetestimonial');
    Route::post('/testimonials/update/{id}','AdminController@updatetestimonial');
    Route::get('/testimonials/delete/{id}','AdminController@destroytestimonial');
    Route::get('/testimonials/toggle/{id}','AdminController@toggleLiveTestimonials');

    Route::get('/service/add','ServiceController@create');
    Route::get('/service/view','ServiceController@index');
    ...
    Route::get('/service/toggle/{id}','ServiceController@toggleLiveServices');

    Route::get('/textchangers/view','AdminController@viewtextchangers');
    Route::get('/textchangers/edit/{id}','AdminController@edittextchangers');
    Route::post('/textchangers/update/{id}','AdminController@updatetextchangers');

    Route::get('/addAdmin','AdminController@register');
    Route::get('/viewAdmin','AdminController@viewadmins');
...
Route::post('/0F9218EFBD35116FA202A20B5A3A3B03420F00929E4343E339F7B1622A598C70','AdminController@validatelogin');
Route::post('/F39B993C2AA0285BEE3CDEEEC14EC530FB23CF192525581EDA0B25D0319FF1E3','AdminController@storecontacts');
