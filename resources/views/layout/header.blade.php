    ...
    <div class="container">
      <ul class="nav page-navigation">
        ...
        <li class="nav-item {{ active_class(['email/*', 'apps/*']) }}">
          ...
          <div class="submenu">
            <ul class="submenu-item">
              <li class="category-heading">Customers<li>
              <li class="nav-item"><a class="nav-link" href="/admin/contact/0">Not Contacted</a></li>
              <li class="nav-item"><a class="nav-link" href="/admin/contact/1">Contacted</a></li>
            </ul>
          </div>
        </li>
        ...
        <li class="nav-item {{ active_class(['email/*', 'apps/*']) }}">
            ...
            <div class="submenu">
              <ul class="submenu-item">
                <li class="category-heading">Testimonials<li>
                <li class="nav-item"><a class="nav-link" href="/admin/testimonials/view">All testimonials</a></li>
                <li class="nav-item"><a class="nav-link" href="/admin/testimonials/add">Add Testimonial</a></li>
              </ul>
            </div>
        </li>
        ...
        <li class="nav-item {{ active_class(['email/*', 'apps/*']) }}">
            ...
            <div class="submenu">
              <ul class="submenu-item">
                <li class="category-heading">Services<li>
                <li class="nav-item"><a class="nav-link" href="/admin/service/view">All services</a></li>
                <li class="nav-item"><a class="nav-link" href="/admin/service/add">Add service</a></li>
              </ul>
            </div>
        </li>
        ...
        <li class="nav-item {{ active_class(['email/*', 'apps/*']) }}">
            <a href="#" class="nav-link">
              ...
              <span class="menu-title">Textchangers</span>
              <i class="link-arrow"></i>
            </a>
            <div class="submenu">
              <ul class="submenu-item">
                <li class="category-heading">Textchangers<li>
                <li class="nav-item"><a class="nav-link" href="/admin/textchangers/view">All Textchangers</a></li>
              </ul>
            </div>
        </li>
        ...
        <li class="nav-item {{ active_class(['email/*', 'apps/*']) }}">
            ...
            <div class="submenu">
              <ul class="submenu-item">
                <li class="category-heading">Admins<li>
                <li class="nav-item"><a class="nav-link" href="/admin/viewAdmin">All Admins</a></li>
